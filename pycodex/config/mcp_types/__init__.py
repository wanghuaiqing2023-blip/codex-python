"""MCP server configuration package ported from ``codex-config``."""
...
from . import option_duration_secs
...
class McpServerConfig:
    ...
    def from_mapping(cls, data: Mapping[str, Any]) -> "McpServerConfig":
        ...
        return cls(
            ...
            tool_timeout_sec=option_duration_secs.deserialize(
    ...
    def to_mapping(self) -> dict[str, Any]:
        ...
        if self.startup_timeout_sec is not None:
            result["startup_timeout_sec"] = option_duration_secs.serialize(
                self.startup_timeout_sec
            )
        if self.tool_timeout_sec is not None:
            result["tool_timeout_sec"] = option_duration_secs.serialize(
...
def _duration_from_raw(data: Mapping[str, Any]) -> float | None:
    if _present(data, "startup_timeout_sec"):
        return option_duration_secs.deserialize(data["startup_timeout_sec"])
