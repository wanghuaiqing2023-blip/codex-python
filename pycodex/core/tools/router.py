...
from pycodex.core.tools.context import FunctionToolOutput, PostToolUseFeedbackOutput, ToolPayload
from pycodex.core.tools.tool_dispatch_trace import ToolDispatchTrace
...
async def dispatch_tool_call_with_terminal_outcome(
    ...
    **stores: Any,
    ...
    from pycodex.core.tools.parallel import ToolCallResult
...
def _tool_pre_tool_use_payload(tool: Any, invocation: ToolInvocation) -> Any:
    ...
    if method is None:
        from pycodex.core.tools.registry import pre_tool_use_payload
...
def _tool_post_tool_use_payload(tool: Any, invocation: ToolInvocation, output: Any) -> Any:
    ...
    if method is None:
        from pycodex.core.tools.registry import post_tool_use_payload
