...
class SpawnAgentsOnCsvHandler:
    ...
    def tool_name(self) -> ToolName:
        return ToolName.plain(agent_jobs_spec.SPAWN_AGENTS_ON_CSV_TOOL_NAME)

    def spec(self) -> dict[str, JsonValue]:
        return agent_jobs_spec.create_spawn_agents_on_csv_tool()
...
from .spawn_agents_on_csv import (
    single_local_environment_cwd,
)

from .report_agent_job_result import ReportAgentJobResultHandler
