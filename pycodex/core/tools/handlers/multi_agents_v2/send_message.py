...
from .message_tool import MessageDeliveryMode, SendMessageArgs, handle_message_string_tool, message_content
...
class SendMessageHandler:
    ...
    def handle(self, invocation: ToolInvocation) -> FunctionToolOutput:
        ...
        return handle_message_string_tool(mode=MessageDeliveryMode.QUEUE_ONLY, target=args.target, message=args.message, send_message=self._send_message, get_agent_metadata=self._get_agent_metadata)
