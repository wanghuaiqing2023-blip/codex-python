"""Skill discovery and parsing aligned with ``codex-core-skills::loader``."""
...
from .invocation_utils import SkillLoadOutcome
...
def load_skills_from_roots(roots: tuple[SkillRoot, ...]) -> SkillLoadOutcome:
...
__all__ = ["SkillRoot", "load_skills_from_roots", "skill_roots"]
