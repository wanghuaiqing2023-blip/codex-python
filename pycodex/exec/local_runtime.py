...
DEFAULT_LOCAL_HTTP_MAX_OUTPUT_TOKENS = 10_000
LOCAL_HTTP_APPROX_BYTES_PER_TOKEN = 4
LOCAL_HTTP_EXEC_MIN_YIELD_TIME_MS = 250
LOCAL_HTTP_EXEC_MIN_EMPTY_STDIN_YIELD_TIME_MS = 5_000
LOCAL_HTTP_EXEC_MAX_YIELD_TIME_MS = 30_000
LOCAL_HTTP_EXEC_MAX_BACKGROUND_TERMINAL_TIMEOUT_MS = 300_000
LOCAL_HTTP_EXEC_TIMEOUT_EXIT_CODE = 124
LOCAL_HTTP_EXEC_OUTPUT_MAX_BYTES = 1024 * 1024
LOCAL_HTTP_EXEC_OUTPUT_MAX_TOKENS = LOCAL_HTTP_EXEC_OUTPUT_MAX_BYTES // LOCAL_HTTP_APPROX_BYTES_PER_TOKEN
LOCAL_HTTP_MAX_UNIFIED_EXEC_PROCESSES = 64
...
def _clamp_local_http_yield_time_ms(value: int | float, *, empty_stdin: bool = False) -> float:
    minimum = LOCAL_HTTP_EXEC_MIN_EMPTY_STDIN_YIELD_TIME_MS if empty_stdin else LOCAL_HTTP_EXEC_MIN_YIELD_TIME_MS
    maximum = (
        LOCAL_HTTP_EXEC_MAX_BACKGROUND_TERMINAL_TIMEOUT_MS
        if empty_stdin
        else LOCAL_HTTP_EXEC_MAX_YIELD_TIME_MS
    )
