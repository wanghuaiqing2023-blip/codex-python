"""Rust-aligned implementation for codex-cli debug_sandbox::parent."""
    ...
    if plan.mode == "elevated":
        ...
        return run_windows_sandbox_capture_for_permission_profile(
            ElevatedSandboxProfileCaptureRequest(
                ...
                False,
                deny_read_paths_override=tuple(plan.deny_read_paths_override),
                deny_write_paths_override=tuple(plan.deny_write_paths_override),
            )
        )
...
def run_debug_sandbox_windows_product_session(
    ...
    *,
    ...
    if process_stdin is not None:
        spawn_input_forwarder(stdin, process_stdin)
...
from pycodex.cli.debug_sandbox.pid_tracker import PidTracker, list_child_pids, pid_is_alive, track_descendants
from pycodex.cli.debug_sandbox.seatbelt import DebugSandboxDenialLogResult, DebugSandboxDenialLoggerPlan, SandboxDenial, build_debug_sandbox_denial_logger_plan, collect_debug_sandbox_seatbelt_denials, finish_debug_sandbox_denial_logger_plan, format_debug_sandbox_denial_summary, parse_message
from pycodex.cli.debug_sandbox.windows_stdio_bridge import DebugSandboxWindowsSessionIoBridgeResult, DebugSandboxWindowsSpawnBridgeResult, STDIN_FORWARD_CHUNK_SIZE, run_debug_sandbox_windows_session_io_bridge, run_debug_sandbox_windows_session_with_stdio_bridge, spawn_input_forwarder, spawn_output_forwarder, windows_output_forward_bytes, windows_stdin_forward_chunks
