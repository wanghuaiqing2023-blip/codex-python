...
RUST_MODULE = RustTuiModule(crate="codex-tui", module="chatwidget::protocol", source="codex/codex-rs/tui/src/chatwidget/protocol.rs")
...
class ProtocolWidget(Protocol):
    ...
    last_rendered_user_message_display: Any | None


def handle_server_notification(
    widget: Any,
    notification: ServerNotification | Mapping[str, Any] | Any,
    ...
    if kind == "ThreadTokenUsageUpdated":
        _call(widget, "set_token_info", _get(payload, "token_usage", None))
...
def handle_turn_completed_notification(
    widget: Any,
    notification: TurnCompletedNotification | Mapping[str, Any] | Any,
    replay_kind: ReplayKind | str | None = None,
) -> None:
...
def handle_item_started_notification(
    widget: Any,
    notification: ItemStartedNotification | Mapping[str, Any] | Any,
    from_replay: bool,
) -> None:
...
def handle_item_completed_notification(
    widget: Any,
    notification: ItemCompletedNotification | Mapping[str, Any] | Any,
    replay_kind: ReplayKind | str | None = None,
) -> None:
...
def _kind(value: ServerNotification | Mapping[str, Any] | Any) -> str:
...
def _payload(value: ServerNotification | Mapping[str, Any] | Any) -> Any:
...
def _replay_name(value: ReplayKind | str | None) -> str | None:
