...
from tests.support.tui_terminal import TerminalCapture
...
def test_resize_reflow_split_restore_keeps_history_and_composer_rows_anchored() -> None:
...
def test_resize_reflow_repeated_resizes_do_not_push_composer_down() -> None:
