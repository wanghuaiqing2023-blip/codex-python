...
def normalizeReference(string: str) -> str:
    ...
    # In node v10 '岷?.toLowerCase() === '峁?, which is presumed to be a bug
    ...
    # 陌, 洗, 岷? 鈩? 鈩? 鈩?- those are already uppercased, but have differently
    # uppercased versions).
    #
    # Here's an example showing how it happens. Lets take greek letter omega:
    # uppercase U+0398 (螛), U+03f4 (洗) and lowercase U+03b8 (胃), U+03d1 (蠎)
    #
    # Unicode entries:
    ...
    #
    # But .toLowerCase() doesn't change 蠎 (it's already lowercase),
    # and .toUpperCase() doesn't change 洗 (already uppercase).
    #
