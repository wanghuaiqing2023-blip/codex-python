...
CORE_RUNTIME_DEPENDENCY_PACKAGES = {
    ...
    "codex-extension-api": ("pycodex/ext/extension_api", "codex-extension-api", "codex/codex-rs/ext/extension-api"),
    "codex-feedback": ("pycodex/feedback", "codex-feedback", "codex/codex-rs/feedback"),
    "codex-mcp": ("pycodex/codex_mcp", "codex-mcp", "codex/codex-rs/codex-mcp"),
